...
public class FacturaEstrategia implements InterfaceStrategy
{
    FacturaDAO facturadao=new FacturaDAO();

    public FacturaEstrategia() {
    }
    ...
    public void visualize(DefaultTableModel modelo, int tipo) {
        facturadao.visualizeFacturaAnular(modelo);
    }
...
//        Usuario usuario;
//        usuario = (Usuario) obj;
//        facturadao.modifyUsuario(usuario, numUsuario);
    }
    ...
    public void vizualizeTextoPedidoDatos(JTextField txtuno, JTextField txtdos, JTextField txttres, JTextField txtcuatro, String codigoPedido) {
        facturadao.visualizarCliente(txtuno, txtdos, txttres, txtcuatro, codigoPedido);
    }
    ...
    public void modificarContrasena(String nuevaContrasena, String numUsuario) {
        facturadao.modificarAnulada(numUsuario, numUsuario);
    }
