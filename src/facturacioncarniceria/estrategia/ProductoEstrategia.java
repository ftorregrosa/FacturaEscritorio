...
public class ProductoEstrategia implements InterfaceStrategy
{
    ProductoDAO productodao=new ProductoDAO();

    public ProductoEstrategia() {
    }
    ...
    public void visualize(DefaultTableModel modelo, int tipo) {
        productodao.visualizeProducto(modelo);
    }
    ...
    public void modify(Object obj, String numUsuario) {
        Producto producto;
        producto = (Producto) obj;
        productodao.modificarProducto(producto, numUsuario);
    }
